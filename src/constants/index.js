...
const words = [
  { id: 1, text: "Ideas", imgPath: `${base}images/ideas.svg` },
  { id: 2, text: "Concepts", imgPath: `${base}images/concepts.svg` },
  { id: 3, text: "Designs", imgPath: `${base}images/designs.svg` },
  { id: 4, text: "Code", imgPath: `${base}images/code.svg` },
  { id: 5, text: "Ideas", imgPath: `${base}images/ideas.svg` },
  { id: 6, text: "Concepts", imgPath: `${base}images/concepts.svg` },
  { id: 7, text: "Designs", imgPath: `${base}images/designs.svg` },
  { id: 8, text: "Code", imgPath: `${base}images/code.svg` },
];
...
const logoIconsList = [
  {
    imgPath: `${base}images/logos/HTML.png`,
  },
  {
    imgPath: `${base}images/logos/JS.png`,
  },
  {
    imgPath: `${base}images/logos/JAVA.png`,
  },
  {
    imgPath: `${base}images/logos/REACT.png`,
  },
  {
    imgPath: `${base}images/logos/NEXT.png`,
  },
  {
    imgPath: `${base}images/logos/EXPRESS.png`,
  },
  {
  ...
  {
    imgPath: `${base}images/logos/SQL.png`,
  },
  {
    imgPath: `${base}images/logos/Mongo.png`,
  },
  {
    imgPath: `${base}images/logos/Tailwind.png`,
  },
];
...
const techStackImgs = [
  ...
  {
    name: "Java Developer",
    imgPath: `${base}images/logos/icons8-spring-boot-240.svg`,
  },
  // {
...
const expCards = [
  {
    ...
    logoPath: `${base}images/NoobDev.png`,
...
const testimonials = [
  ...
  },
  {
    ...
    imgPath: `${base}images/muthmar.jpg`,
  },
  {
    name: "Pedri Gonzalez",
  ...
  },
  {
    ...
    // Note: yamal.jpg is not present in /public/images; using an existing image to avoid 404s.
    imgPath: `${base}images/pedri.jpg`,
  },
  {
    name: "Antony",
    ...
    // Note: antony.jpg is not present in /public/images; using an existing image to avoid 404s.
    imgPath: `${base}images/pendu.jpg`,
  },
];
